...
export default function AuthForm({ mode, onModeChange }: AuthFormProps) {
  ...
  return (
    <section className='w-full min-w-0 max-w-lg rounded-[24px] border border-primary/40 bg-white-base/85 p-4 shadow-[0px_20px_80px_rgba(45,45,45,0.12)] backdrop-blur sm:p-5 sm:rounded-[32px] lg:p-8'>
          ...
          <>
            <div className='grid gap-4 sm:grid-cols-2'>
              <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                ...
                <input
                  ...
                  className={errors.firstName ? invalidInputClassName : inputClassName}
                />
                {errors.firstName ? (
                  <span className='text-extra-small text-error'>{errors.firstName}</span>
                ) : null}
              </label>
              ...
              <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                ...
                />
                {errors.lastName ? (
                  <span className='text-extra-small text-error'>{errors.lastName}</span>
                ) : null}
              </label>
            </div>
            ...
            {isProviderSelected && (
              <div className='space-y-4 border-t border-primary/20 pt-4 mt-2'>
                <p className='text-small-medium text-dark-base'>Business Information</p>
                ...
                <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                  ...
                  <input
                    ...
                    className={errors.businessName ? invalidInputClassName : inputClassName}
                  />
                  {errors.businessName ? (
                    <span className='text-extra-small text-error'>{errors.businessName}</span>
                  ) : null}
                </label>
                ...
                <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                  ...
                  />
                  {errors.description ? (
                    <span className='text-extra-small text-error'>{errors.description}</span>
                  ) : null}
                </label>
                ...
                <div className='grid gap-4 sm:grid-cols-2'>
                  <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                    ...
                    <input
                      ...
                      className={errors.location ? invalidInputClassName : inputClassName}
                    />
                    {errors.location ? (
                      <span className='text-extra-small text-error'>{errors.location}</span>
                    ) : null}
                  </label>
                  ...
                  <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                    ...
                    <input
                      ...
                      onChange={(event) => {
                        ...
                        setErrors((current) => ({ ...current, businessAddress: undefined }));
                      }}
                      placeholder='Full business address'
                      aria-invalid={Boolean(errors.businessAddress)}
                      className={errors.businessAddress ? invalidInputClassName : inputClassName}
                    />
                    {errors.businessAddress ? (
                      <span className='text-extra-small text-error'>{errors.businessAddress}</span>
                    ) : null}
                  </label>
                </div>
                  ...
                  <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                    ...
                    <input
                      ...
                      onChange={(event) => {
                        ...
                        setErrors((current) => ({ ...current, companyEmail: undefined }));
                      }}
                      placeholder='business@example.com'
                      aria-invalid={Boolean(errors.companyEmail)}
                      className={errors.companyEmail ? invalidInputClassName : inputClassName}
                    />
                    {errors.companyEmail ? (
                      <span className='text-extra-small text-error'>{errors.companyEmail}</span>
                    ) : null}
                  </label>
                  ...
                  <div className='flex flex-col gap-2 text-small-medium text-dark-base'>
                    ...
                    <PhoneInput
                      ...
                      onChange={(value) => {
                        ...
                        setErrors((current) => ({ ...current, companyPhone: undefined }));
                      }}
                      inputProps={{
                        required: true,
                        name: 'companyPhone',
                    ...
                    />
                    {errors.companyPhone ? (
                      <span className='text-extra-small text-error'>{errors.companyPhone}</span>
                    ) : null}
                  </div>
                </div>
                ...
                <label className='flex flex-col gap-2 text-small-medium text-dark-base'>
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      setErrors((current) => ({ ...current, cacNumber: undefined }));
                    }}
                    placeholder='RC 1234567'
                    aria-invalid={Boolean(errors.cacNumber)}
                    className={errors.cacNumber ? invalidInputClassName : inputClassName}
                  />
                  {errors.cacNumber ? (
                    <span className='text-extra-small text-error'>{errors.cacNumber}</span>
                  ) : null}
                </label>
              </div>
            )}
      ...
      {message ? (
        <p className='mt-4 rounded-2xl bg-primary-50 p-4 text-small text-dark-base'>{message}</p>
      ) : null}
    </section>
  );
}
