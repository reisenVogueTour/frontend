...
export default function AuthPage() {
  ...
  return (
    <section className="flex min-h-svh justify-center bg-[linear-gradient(to_top,#cfbeea,#f9fafb_80%)] px-4 pb-20 pt-24 sm:px-6 md:px-8 lg:px-10 lg:pb-24 lg:pt-28">
